...
{n:'教官搜書包',stg:'young',
 ...
 o:[
  ...
  {t:'說是幫爸爸看的', p:48, g:{mood:3},
   ...
   b:{life:-3,mood:-5}, bt:'他打了電話回家。那通電話之後，家裡的氣氛有半年不太對。'},
  {t:'把畫面切掉，裝沒事', p:34, g:{mood:4},
   gt:'你切得夠快。那天之後你養成了鎖螢幕的習慣，這習慣跟了你很多年。',
   b:{life:-4,mood:-7}, bt:'他看到了你切畫面的動作。事情從「看盤」變成「說謊」。'}
 ]},

{n:'大夜班',stg:'young',
 d:'便利商店的大夜班，時薪一百八。你算過，做滿三個月可以多買兩張。',
 o:[
  {t:'做滿三個月', g:{nav:16,life:-4},
...
{n:'她問你在忙什麼',stg:'young',loveSt:'dating',
 ...
 o:[
  {t:'照實說', p:55, g:{life:5,mood:6},
   ...
   b:{life:-2,mood:-6}, bt:'她「喔」了一聲，話題就轉走了。你那天回家路上想了很久。'},
...
{n:'假投資群',stg:'*',block:'quiet',
 ...
 o:[
  ...
  {t:'先查一下這個人', p:72, g:{hab:{read:3,log:2}},
   ...
   b:{life:-2,mood:-4}, bt:'查了半天查不出所以然。你把對話刪掉，但那個連結你還留著。'},
  {t:'小額試水溫', p:20, g:{nav:8,mood:5},
   gt:'第一筆真的出金了。你後來才知道，那是他們的成本——用來換你下一筆大的。',
   b:{nav:-32,mood:-15,life:-2}, bt:'出金要先繳「保證金」。你才發現整個平台的數字都是畫出來的。'}
 ]},
...
{n:'當沖上癮',stg:'*',
 ...
 o:[
  ...
  {t:'加大部位，這才有搞頭', p:27, g:{nav:18,mood:10},
   ...
   b:{nav:-25,life:-3,mood:-9}, bt:'部位大了虧損也大了，而手續費是照倍數算的。那個月的稅費比伙食費高。'}
 ]},
...
{n:'健康檢查紅字',stg:'*',
 ...
 o:[
  ...
  {t:'先把這一季撐完', p:52, g:{nav:6},
   ...
   b:{life:-4,mood:-4}, bt:'那一季結束的時候你掛了急診。醫生翻著上一份報告，什麼都沒說。'},
  {t:'報告收起來，不要想它', g:{life:-5,mood:4},
...
{n:'過年被問收益率',stg:'pro',
 ...
 o:[
  ...
  {t:'照實說', p:54, g:{life:3,hab:{family:3}},
   ...
   b:{life:-3,mood:-6}, bt:'數字說出口的那一刻，桌上安靜了兩秒。那兩秒你記了很久。'},
  {t:'講得比實際好聽', p:46, g:{mood:6},
   gt:'那頓飯你是主角。回家的路上你在心裡把數字又算了一次，還是不對。',
   b:{life:-2,mood:-8,trust:-6}, bt:'有人真的拿錢來找你操作。你才發現吹過的牛是要還的。'}
 ]},
...
{n:'老闆發現你上班看盤',stg:'pro',need_job:1,
 ...
 o:[
  ...
  {t:'改成只看收盤', p:60, g:{hab:{close:3,log:2}},
   ...
   b:{life:-2,mood:-4}, bt:'撐了三週。第四週你又開始每隔十分鐘翻一次手機。'},
  {t:'照看，反正他不敢怎樣', p:38, g:{nav:9,mood:5},
   gt:'那年你盤中抓到幾波，賺的比年終多。你開始覺得這份工作只是個地方坐。',
   b:{nav:-6,life:-3,mood:-9}, bt:'考績出來，你被調到一個沒有窗戶的位子。沒有人跟你說原因。'}
 ]},
...
{n:'朋友要跟單',stg:'pro',
 ...
 o:[
  ...
  {t:'照實告訴他風險', p:58, g:{nav:5,hab:{log:2}},
   ...
   b:{life:-2}, bt:'他只聽到「有機會」三個字。賠掉之後，他覺得你早就知道會這樣。'},
...
{n:'另一半說該買房了',stg:'pro',minAge:26,loveSt:'attached',
 ...
 o:[
  ...
  {t:'兩邊各退一步', p:60, g:{life:4,hab:{family:3}},
   ...
   b:{life:-3,mood:-5}, bt:'折衷的意思是兩個人都不滿意。這件事之後被提起過很多次。'},
  {t:'再等一年，我算過的', p:38, g:{nav:14,mood:6},
   gt:'那一年市場真的漲了。你把試算表拿給他看，他沒有說話。',
   b:{life:-6,mood:-10}, bt:'房價漲得比你的部位快。「我算過的」這四個字，你以後不敢再講。'}
 ]},
...
{n:'父母生病',stg:'pro',minAge:28,
 ...
 o:[
  ...
  {t:'借錢週轉，部位不動', p:50, g:{nav:-4},
   ...
   b:{nav:-18,life:-3,mood:-9}, bt:'借的錢跟賠的錢一起來。那半年你沒有一天睡超過五小時。'},
...
{n:'岳家的錢',stg:'pro',minAge:28,loveSt:'married',
 ...
 o:[
  ...
  {t:'接，但講清楚可能會賠', p:56, g:{trust:6,hab:{family:3}},
   ...
   b:{life:-3,trust:-8}, bt:'話講在前面沒有用。數字一綠，前面講的都不算了。'},
  {t:'接下來，一定會賺', p:34, g:{nav:10,trust:8},
   gt:'第一年就賺了。過年時你是全家最會做人的那一個。',
   b:{life:-6,mood:-12,trust:-20}, bt:'那筆錢賠了三成。他們一句重話都沒說，這件事因此更難過去。'}
 ]},
...
{n:'同學會',stg:'pro',
 ...
 o:[
  ...
  {t:'講得像那麼一回事', p:44, g:{mood:7},
   ...
   b:{life:-3,mood:-8}, bt:'有人拿出手機查了那檔的走勢，當場對不上。'}
 ]},
...
{n:'公司裁員',stg:'pro',need_job:1,
 ...
 o:[
  ...
  {t:'什麼都不做，等消息', p:52, g:{mood:2},
   ...
   b:{life:-4,mood:-10}, bt:'名單有你。資遣費入帳那天，你把它全部丟進市場——這個決定日後你會反覆想起。'},
  {t:'主動去談，換部門', p:44, g:{life:3},
   gt:'你換到一個比較穩的位子。薪水少一點，但那一波沒有掃到你。',
   b:{life:-3,mood:-6}, bt:'你去談了，主管的表情讓你知道自己本來不在名單上。'}
 ]},
...
{n:'開直播當老師',stg:'pro',
 ...
 o:[
  ...
  {t:'開了但不收費', p:58, g:{hab:{log:3,read:2}}, fame:1,
   ...
   b:{life:-3,mood:-5}, bt:'留言區開始有人問明牌，你不回，他們就說你藏私。'},
  {t:'開課，一堂四萬八', p:50, g:{nav:14,mood:8}, fame:1,
   gt:'第一梯就滿了。你發現教課的現金流比操作穩定得多——這件事你沒有跟學員說。',
   b:{life:-3,mood:-9,trust:-6}, bt:'有學員把你的對帳單跟課程文宣放在一起比對，貼上網。'}
 ]},
...
{n:'內線訊息',stg:'pro',
 ...
 o:[
  ...
  {t:'明天開盤就進場', p:56, g:{nav:26},
   ...
   b:{nav:-24,trust:-15,life:-3,mood:-9}, honor:'曾因不明資金往來被關切',
...
{n:'帳戶破千萬那天',once:1,stg:'*',minNav:1000,
 ...
 o:[
  ...
  {t:'發出去，我值得', p:48, g:{mood:10}, fame:1,
   ...
   b:{life:-3,mood:-8,trust:-5}, bt:'有人截圖轉到別的群組，配上一句「就這樣也敢發」。'}
 ]},
...
{n:'房子還是股票',stg:'pro',minAge:26,minNav:200,
 ...
 o:[
  ...
  {t:'再等一年', p:46, g:{nav:12},
   ...
   b:{life:-4,mood:-9}, bt:'房價漲了兩成，你的部位沒有。那張沒貼成的紙後來也沒再提。'},
...
/* ---- 灰色地帶的另一側：你不是被騙的人，你是被找上的共犯 ---- */
{n:'他說想借你的證券戶',stg:'*',minAge:20,maxNav:300,
 d:'高中同學的哥哥。「戶頭放著也是放著，一個月三千，你什麼都不用做。」',
 o:[
  {t:'拒絕，並且封鎖', g:{hab:{quiet:2},mood:-2},
   gt:'他說你不夠意思。半年後，新聞裡那檔炒作股的名字你有印象——人頭戶名單裡，有兩個你認識的名字。'},
  {t:'問清楚要做什麼', p:55, g:{hab:{read:2},mood:2},
   gt:'他支支吾吾。你聽懂了——這不是「放著」。你說再想想，然後再也沒回。',
   b:{life:-2,mood:-4}, bt:'問太多了。對方換了語氣：「你已經知道太多了。」接下來三個月，你都在後悔多問的那一句。'},
  {t:'答應——躺著賺三千', p:40, g:{nav:3,mood:4},
   gt:'三千塊準時入帳，像收房租。你盡量不去想那個戶頭每天在做什麼。',
   b:{nav:-15,trust:-12,life:-5,mood:-8},
   bt:'炒作案爆了，檢調的傳喚名單上有你。「人頭戶」三個字進了筆錄——罰的比你收的多五倍，而認識你的人都看到了新聞。'}
 ]},

{n:'有團隊想跟你「合作」',stg:'pro',minAge:28,minNav:600,
 d:'私訊來的。「會員費三七分，你只要負責講盤，收會員我們來。」附了另一個老師的月結單：七位數。',
 o:[
  {t:'封鎖', g:{hab:{quiet:3}},
   gt:'你盯著那張月結單看了很久，然後按下封鎖。那個數字，你記得比很多事都清楚。'},
  {t:'回「只講邏輯，不帶單」', p:50, g:{nav:3,trust:4,mood:3},
   gt:'他們覺得你沒有用，自己走了。你開了一個只講邏輯的頻道，留下來的聽眾不多，但都是真的。',
   b:{mood:-5,life:-3}, bt:'「只講邏輯」沒有流量。你關台那天，對面帶單的老師正在開香檳慶祝會員破千。'},
  {t:'簽了——七位數誰不要', p:35, g:{nav:18,mood:10},
   gt:'三個月你賺了操作五年的錢。你開始理解那些老師為什麼不操盤了——這一行的報酬率比較高。',
   b:{nav:-12,trust:-20,life:-6,mood:-10},
...
/* ---- 時事原型三部曲：引用現象，不引用日期——
   ...
   新高恐懼（空手等崩盤的機會成本）。 */
{n:'新的高股息 ETF 開募，號稱銅板價',stg:'*',minAge:20,
 d:'你媽問你要不要幫她也買一張。她說銀行的人排到門口，「大家都在買」。',
 o:[
  {t:'跟她解釋：ETF 沒有「便宜」這回事', g:{trust:4,life:3,hab:{read:2}},
   gt:'你畫圖解釋淨值跟市價。她聽完還是買了一張，「反正比定存好」。但從此她的理財問題都先問你。'},
  {t:'幫她買，自己也跟一張', p:55, g:{nav:3,life:2,mood:3},
   gt:'開募熱潮延續了一季，你們小賺。她逢人就說兒子會理財。',
   b:{nav:-4,mood:-4}, bt:'溢價回落那週，她問你「怎麼變少了」。你解釋了半小時，她說「早知道放定存」。'},
  {t:'重壓——全民搶的東西不會錯', p:40, g:{nav:9,mood:7},
   gt:'這一波你搭上了。人多的地方有時候真的有錢，你開始懷疑教科書。',
   b:{nav:-10,mood:-8,life:-2}, bt:'排隊的人買完了，就沒有下一批人了。你在最熱鬧的那天進場，接下來安靜了很久。'}
 ]},

{n:'大學同學說，股票太慢了',stg:'*',minAge:20,
 d:'他上個月在幣圈賺了三倍。「這是新世界，你們還在玩舊的。」',
 o:[
  {t:'回去研究那到底是什麼', g:{hab:{read:3}},
   gt:'你花一個週末搞懂了他自己都講不清楚的東西，然後決定：看不懂的錢不賺。他說你古板。'},
  {t:'拿一小筆進去試', p:42, g:{nav:12,mood:6},
   gt:'三週翻了快一倍。你開始半夜醒來看行情——它不收盤。',
   b:{nav:-11,mood:-6}, bt:'一根大陰線把一個月的漲幅吃掉。你發現這裡的跌停是沒有底的。'},
  {t:'梭哈——新世界不等人', p:30, g:{nav:34,mood:12},
   gt:'那三個月你賺得不像話。你在同學會講課，講到一半發現自己在講的跟當年報明牌的學長一模一樣。',
   b:{nav:-30,life:-4,mood:-12}, bt:'交易所凍結提領那天，他的三倍和你的本金一起變成一則道歉聲明。'}
 ]},

{n:'大盤創了歷史新高',stg:'*',minAge:22,
 d:'你認識的每一個人都說「要崩了」。已經說了十四個月。',
 o:[
  {t:'照原本的節奏，繼續投入', g:{hab:{dca:3},mood:-2},
   gt:'你關掉那則「歷史大頂」的影片，按下這個月的定期定額。後來它又漲了一年，也跌過兩次——你都在場。'},
  {t:'獲利了結一半，等回檔接回', p:45, g:{nav:5,mood:4},
   gt:'回檔真的來了，你接得漂亮。這種事你這輩子大概還能再對一次。',
   b:{nav:-6,mood:-5}, bt:'你等的回檔是漲上去的。三個月後你用更高的價格把部位接回來。'},
  {t:'全部出清，現金為王', p:30, g:{nav:8,mood:6},
   gt:'你賣在起跌前三天。那一年你是群組裡唯一的神。',
   b:{nav:-9,mood:-7,life:-2}, bt:'你等的崩盤沒有來。十四個月後你在更高的位置買回原來的部位——中間的漲幅，是你付的學費。'}
 ]},
...
{n:'有人要把錢交給你',stg:'pro',minNav:600,trustMin:50,
 ...
 o:[
  ...
  {t:'接下來再說', p:44, g:{trust:6,nav:5},
   ...
   b:{trust:-14,life:-4}, bt:'第一年就賠。沒有寫過的規則，事後怎麼講都是你的錯。'}
 ]}
...
/* ---- 把「會變成什麼」直接算給他看 ----
   ...
   都用同一個單位講，一眼就比得出來。 */
function amt(v){
  /* 精度跟著數量級走：小數點在幾百塊的時候有意義，在一百多萬的時候
     只是把副標撐長一行。實測「139.7 萬」那種寫法會把選項擠成兩行。 */
  const a=Math.abs(v);
  if(a<1)      return Math.round(v*10000)+' 元';   /* 一萬以下講「元」——「0.2 萬」沒有人在心裡換算 */
  if(a<10)     return v.toFixed(1)+' 萬';
  ...
  {id:'stale', ask:1, pick:function(g){
    ...
    return {q:prev+'概念股是去年的題材，今年沒有人在講了。它現在'+pctText(h.pl)+'。',
      opts:[
        ...
        {t:'賣一半，留一點', n:sellNote(g,h.id,0.5,die), s:'它回來你還在車上',
         mv:'sell:'+h.id, arg:{frac:0.5}},
        {t:'再等等，它會回來', s:'去年它讓你賺很多', skip:1}
      ]};
  }},
  /* 維持率吃緊 ----
